...
# Connection string format: postgresql://postgres:[YOUR-PASSWORD]@db.qvslbiceoonrgjxzkotb.supabase.co:5432/postgres
...
```bash
curl -X GET 'https://qvslbiceoonrgjxzkotb.supabase.co/rest/v1/profiles?select=*&limit=1' \
