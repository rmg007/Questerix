...
import { generateTestUser, generateTestDomain, generateTestSkill, generateTestQuestion, TEST_CREDENTIALS } from './test-utils';
...
// Radix Select helper
async function selectOption(page, triggerSelector, optionTextOrIndex) {
